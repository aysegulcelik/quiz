<x-app-layout>
    ...
    <div class="card">
        <div class="card-boy">
            <form method="HEAD" action="{{route('question.update',[$question->quiz_id,$question->id])}}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>1.Cevap</label>
                            <textarea name="answer1" style="height: 10px" class="form-control" rows="4" >{{$question->answer1}}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>2.Cevap</label>
                            <textarea name="answer2" style="height: 10px" class="form-control" rows="4" >{{$question->answer2}}</textarea>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>3.Cevap</label>
                            <textarea name="answer3" style="height: 10px" class="form-control" rows="4" >{{$question->answer3}}</textarea>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>4.Cevap</label>
                            <textarea name="answer4" style="height: 10px" class="form-control" rows="4" >{{$question->answer4}}</textarea>
                        </div>
                    </div>
                </div>
                <div class="form-group">
